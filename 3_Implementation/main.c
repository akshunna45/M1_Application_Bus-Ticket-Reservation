...
#include 'D:/a/M1_Application_Bus-Ticket-Reservation/M1_Application_Bus-Ticket-Reservation/3_Implementation/inc/read_number.h"
...
char ch[100][500]=
{   
    "Bangalore  - Mangalore         Single Decker           Non-AC      Non-Sleeper     351 KM          07:00 AM           07 Hr 45 Min",
    "Mysore     - Mumbai            Single Decker           AC          Sleeper         1,067 KM        01:00 AM           17 Hr 50 Min",
    "Delhi      - Bangalore         Single Decker           AC          Sleeper         2,175 KM        05:00 AM           37 Hr 00 Min",
    "Mumbai     - Ahmedabad         Single Decker           Non-AC      Non-Sleeper     525 km          03:00 PM           10 Hr 30 Min",
    "Jaipur     - Kolkata           Single Decker           AC          Sleeper         1,577 KM        10:00 PM           28 Hr 15 Min"
};

int trno;

/* Function that login into system */
void login();

/* Function that shows the list of Buses and Routes */
void bus();

/* Function that booking the tickets */
void booking();

/* Function that fetching the person's name and seat number */
void name_number(int booking,char numstr[100]);

/* Function that printing the status by user input */
void status();

/* Function that printing the status while booking ticket */
void status_1(int trno);

/* Function that cancel the booked tickets */
void cancel();
...
int main()
{
    ...
    do
    {
        ...
        printf("\t\t\t\t\t[1]=> View Bus & Route Details\n");
            printf("\n");
        ...
        {
            case 1:
                bus(); //for Details of bus and route
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                status(); //for check the status of available bus seats
                break;
        }
        getch();
    }
...
void bus()
{
    ...
    printf("\t\t\t\t\t Source City to Destination City          Deck                AC          Sleeper         Distance        Leaving Time        Journey Time    \n\n\n");
    printf("\t\t\t\t\t[1]  =>  %s\n",ch[0]);
        printf("\n");
    printf("\t\t\t\t\t[2]  =>  %s\n",ch[1]);
        printf("\n"); 
